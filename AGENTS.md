...
## Interface
### Pagina de predição
Nessa pagina vai ter inputs para preencher com as carcteristicas do imovel cujo o preço deseja ser predito. Ao preencher os dados e clicar no botao, faz a requisição para /predict e recebe o valor predito.

### Pagina de inserção de dados
Página para inserir mais dados de imóveis no sistema

### Pagina do modelo
Contém os dados do ultimo treinamento.
Contém os dados do melhor modelo, o que está sendo usado pelo sistema atualmente.
Contém um botão para retreinar o modelo com os novos dados.

Futuramente: informação de como estar o drifiting do modelo.